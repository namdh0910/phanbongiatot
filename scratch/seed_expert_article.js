...
const BlogSchema = new mongoose.Schema({
  ...
  coverImage: { type: String, default: '/images/blog/default-cover.jpg' },
  excerpt: { type: String },
  ...
  try {
    ...
    const contentHtml = `
      ...
      <div style="background: #f8fafc; border: 2px dashed #cbd5e0; border-radius: 12px; padding: 20px; text-align: center; margin: 20px 0;">
        ...
        <div style="font-weight: 800; color: #4a5568;">[VỊ TRÍ ẢNH BÌA: Cảnh vườn sầu riêng bị ngập hoặc cây héo rũ]</div>
      </div>
    ...
    const newBlog = new Blog({
      ...
      slug: "xu-ly-sau-rieng-thoi-re-sau-ngap-ung",
