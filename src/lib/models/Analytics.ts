...
export interface IAnalytics {
  type: 'page_view' | 'zalo_click' | 'call_click' | 'lead_submit' | 'ViewPopup' | 'QuickBuy_Click' | 'button_click';
...
const analyticsSchema = new Schema<IAnalytics>({
  type: { 
    type: String, 
    required: true,
    enum: ['page_view', 'zalo_click', 'call_click', 'lead_submit', 'ViewPopup', 'QuickBuy_Click', 'button_click']
  },
