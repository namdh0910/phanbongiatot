          ...
          <div className="lg:col-span-2 space-y-6">
             <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                <div>
                   ...
                   <input 
                     required 
                     className="w-full bg-gray-50 border-2 border-transparent rounded-2xl px-6 py-4 text-lg font-black outline-none focus:bg-white focus:border-[#2271b1] transition-all"
                ...
                <div>
                   ...
                   <textarea 
                     required 
                     className="w-full bg-gray-50 border-2 border-transparent rounded-2xl px-6 py-4 text-sm font-medium outline-none focus:bg-white focus:border-[#2271b1] transition-all h-24 resize-none"
                ...
                <div>
                   ...
                   <textarea 
                     required 
                     className="w-full bg-gray-50 border-2 border-transparent rounded-2xl px-6 py-4 text-sm font-medium outline-none focus:bg-white focus:border-[#2271b1] transition-all h-[500px] font-mono"
          ...
          <div className="space-y-6">
             <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div>
                   ...
                   <input 
                     className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2 text-xs font-medium outline-none focus:border-[#2271b1]"
                     placeholder="https://..."
