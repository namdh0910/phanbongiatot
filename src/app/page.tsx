              ...
              activePathologies.length > 0 ? activePathologies.map((pathology, idx) => (
                ...
                >
                  ...
                  <div className="p-3 md:p-8 flex flex-col flex-1 bg-white">
                    <h3 className="text-[11px] md:text-xl font-bold text-gray-800 mb-1 md:mb-3 leading-tight group-hover:text-emerald-700 transition-colors line-clamp-2 md:line-clamp-none lowercase first-letter:uppercase">
                      {pathology.title}
                    </h3>
